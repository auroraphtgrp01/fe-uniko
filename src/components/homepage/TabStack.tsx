          ...
          >
            {active.value === tab.value && (
              <motion.div
                ...
                className={cn('absolute inset-0 rounded-full bg-gray-100/50 dark:bg-zinc-800', activeTabClassName)}
              />
            )}
      ...
      {tabs.map((tab, idx) => (
        <motion.div
          ...
          className={cn(
            ...
            'border border-gray-200 bg-white dark:border-white/10 dark:bg-zinc-900/50',
            className
          )}
        >
          {tab.content}
