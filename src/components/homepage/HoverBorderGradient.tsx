...
>) {
  ...
  return (
    <Tag
      ...
      className={cn(
        'relative flex h-min w-fit flex-col flex-nowrap content-center items-center justify-center gap-10 overflow-visible rounded-full border border-gray-600 bg-white/20 decoration-clone p-px transition duration-500 hover:bg-black/10',
        containerClassName
      )}
      {...props}
    >
