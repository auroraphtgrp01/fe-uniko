...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        'group/bento row-span-1 flex flex-col justify-between space-y-4 rounded-xl border border-white/[0.2] bg-white/50 p-4 shadow-input backdrop-blur-sm transition duration-200 hover:shadow-xl dark:bg-black/50 dark:shadow-none',
        className
      )}
    >
      {header}
