              ...
              >
                ...
                {isJoinExpenditureFundPending && (
                  <p className='mt-2 text-center text-sm text-muted-foreground'>
                    Processing your fund membership request...
                  </p>
                )}
                {joinExpenditureFundData?.statusCode === 200 ? (
                  <div>
                    <p className='mt-2 text-center text-sm text-muted-foreground'>
                      Your membership has been successfully activated. Click the button below to access the fund
                  ...
                  <p className='mt-2 text-center text-sm text-muted-foreground'>
                    Your membership request is pending. Please check your email for the verification link to complete
                    your registration.
                  </p>
                )}
              </motion.div>
